    ...
    <article>
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="project-card project-card-2" style="background-color: #f1f5fd">
                ...
                <figure class="card-banner" data-reveal="left">
                  <img src="{{ asset('images/project-2.png') }}" width="600" height="367" loading="lazy"
            ...
            <li>
              <div class="project-card project-card-3" style="background-color: #f5faf7">
                ...
                <figure class="card-banner" data-reveal="right">
                  <img src="{{ asset('images/project-3.png') }}" width="600" height="367" loading="lazy"
                    alt="Web Design" class="w-100">
                </figure>
            ...
            <li>
              <div class="project-card project-card-4" style="background-color: #fcf4f6">
                ...
                <figure class="card-banner" data-reveal="right">
                  <img src="{{ asset('images/project-4.png') }}" width="620" height="370" loading="lazy"
                    alt="Mobile Design" class="w-100">
                </figure>
      ...
      <section class="section" id="blog" aria-label="blog">
        <div class="container">
          ...
          <p class="section-text">Blog section coming soon.</p>
        </div>
      </section>
